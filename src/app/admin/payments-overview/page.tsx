...
const mockBuildingsData: BuildingType[] = [
  { id: 'building1', name: 'Sunrise Tower', address: '123 Sunrise Ave', penaltyPolicyTiers: [{ fromDay: 6, toDay: 10, feeType: 'Fixed', feeValue: 50 }, { fromDay: 11, feeType: 'Fixed', feeValue: 100 }], createdAt: new Date().toISOString() },
