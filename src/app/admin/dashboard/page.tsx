...
export default function AdminDashboardPage() {
  ...
  const filteredData = useMemo(() => {
    if (!allData) {
      return {
        stats: {
          ...
          totalSpaces: 0,
          totalTenants: 0,
          totalRevenueThisPeriod: "0.00 Birr",
          activeAgreements: 0,
        },
        financials: [],
      };
    ...
    const paidBillsThisPeriod = allData.allBills.filter(
      (bill) =>
        bill.status === "Paid" &&
        bill.paymentDate &&
    ...
    const totalRevenueThisPeriod = paidBillsThisPeriod.reduce(
    ...
    const stats = {
      ...
      totalRevenueThisPeriod: `${totalRevenueThisPeriod.toLocaleString(
        undefined,
  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 mb-8">
        ...
        />
        <OccupancyCard spaces={allData.spaces} buildings={allData.buildings} />
        <StatCard
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col min-h-[140px] sm:col-span-2 lg:col-span-full xl:col-span-2">
          ...
          <CardContent className="flex flex-col flex-grow justify-center">
            <div className="text-3xl lg:text-4xl font-bold font-headline text-foreground">
              {filteredData.stats.totalRevenueThisPeriod}
            </div>
