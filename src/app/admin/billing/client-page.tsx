          ...
          <DialogContent className="sm:max-w-md">
              ...
              <Form {...paymentForm}>
                  <form onSubmit={paymentForm.handleSubmit(handleRecordPaymentSubmit)} className="space-y-4 py-2">
                      ...
                      <FormField control={paymentForm.control} name="paymentReference" render={({ field }) => ( <FormItem><FormLabel>Reference (Optional)</FormLabel><FormControl><Input placeholder="Transaction ID, Check No., etc." {...field} disabled={isReadOnly || isLoading || !canManagePayments}/></FormControl><FormMessage /></FormItem>)} />
            ...
            <div className="flex-grow overflow-y-auto pr-4 py-2">
              <Form {...paymentForm}>
                  <form className="space-y-4"> 
                      ...
                      <FormField control={paymentForm.control} name="paymentReference" render={({ field }) => ( <FormItem><FormLabel>Actual Reference</FormLabel><FormControl><Input placeholder="Transaction ID, Check No., etc." {...field} disabled={isLoading || !canManagePayments}/></FormControl><FormMessage /></FormItem>)} />
